use bevy::{
    ...
    reflect::TypeUuid,
    render::{
        mesh::MeshVertexBufferLayout, render_asset::RenderAssets, render_resource::*,
        renderer::RenderDevice, texture::FallbackImage,
    },
};

use crate::graphics::constants::SKYBOX_CUBEMAP;
...
pub fn asset_loaded(
    ...
    {
        info!("Swapping to {}...", SKYBOX_CUBEMAP.0);
